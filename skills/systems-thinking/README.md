...
- [`SKILL.md`](SKILL.md) — triage, six stages, output contract, confidence gate
- [`references/analysis-phases.md`](references/analysis-phases.md) — the full 20-phase protocol
- [`references/output-template.md`](references/output-template.md) — the 21-section report structure
- [`references/patterns.md`](references/patterns.md) — notation, archetypes, actor template, worked example
